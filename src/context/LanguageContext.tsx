...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'createRecipe.callToActionTitle': '👨‍🍳 Share your recipes!',
    'createRecipe.callToActionDesc': 'Have a special recipe? Share it with the community and inspire other cooks!',
    'createRecipe.notAuthor': 'You do not have permission to edit this recipe',
    'createRecipe.updateError': 'Error updating recipe',
    'editRecipe.title': 'Edit Recipe',
    'editRecipe.subtitle': 'Update your recipe information',
    'editRecipe.description': 'Edit your recipe',
    'editRecipe.updating': 'Updating...',
    'editRecipe.updateButton': 'Update Recipe',
    'community.browseRecipes': 'Browse Recipes',
    'community.confirmDelete': 'Are you sure you want to delete this recipe?',
    'community.deleteError': 'Error deleting recipe',
    edit: 'Edit',
    delete: 'Delete',
    deleting: 'Deleting...',
  ...
  pt: {
    ...
    'community.description': 'Descubra e compartilhe receitas criadas por amantes da culinária de todo o mundo',
    'community.noRecipes': 'Ainda não há receitas',
    ...
    'community.recipeNotFound': 'Receita não encontrada',
    'createRecipe.title': 'Criar Receita',
    'createRecipe.subtitle': 'Compartilhe sua receita favorita com a comunidade',
    'createRecipe.description': 'Crie e compartilhe suas próprias receitas com a comunidade',
    'createRecipe.titleField': 'Título',
    'createRecipe.titlePlaceholder': 'Minha receita deliciosa...',
    'createRecipe.descriptionField': 'Descrição',
    'createRecipe.descriptionPlaceholder': 'Uma breve descrição da receita...',
    'createRecipe.prepTime': 'Tempo de Preparo',
    'createRecipe.servingsField': 'Porções',
    'createRecipe.category': 'Categoria',
    'createRecipe.categoryPlaceholder': 'Sobremesa, Prato Principal, etc.',
    'createRecipe.cuisine': 'Culinária',
    ...
    'createRecipe.ingredientsPlaceholder': '1 xícara de farinha\n2 ovos\n1/2 xícara de açúcar',
    'createRecipe.instructionsField': 'Modo de Preparo',
    'createRecipe.instructionsPlaceholder': 'Pré-aqueça o forno a 180°C\nMisture os ingredientes\nAsse por 30 minutos',
    'createRecipe.onePerLine': 'um por linha',
    'createRecipe.fillRequired': 'Por favor, preencha todos os campos obrigatórios',
    'createRecipe.error': 'Erro ao criar receita',
    'createRecipe.creating': 'Criando...',
    'createRecipe.createButton': 'Criar Receita',
    'createRecipe.callToActionTitle': '👨‍🍳 Compartilhe suas receitas!',
    'createRecipe.callToActionDesc': 'Tem uma receita especial? Compartilhe com a comunidade e inspire outros cozinheiros!',
    'createRecipe.notAuthor': 'Você não tem permissão para editar esta receita',
    'createRecipe.updateError': 'Erro ao atualizar receita',
    'editRecipe.title': 'Editar Receita',
    'editRecipe.subtitle': 'Atualize as informações da sua receita',
    'editRecipe.description': 'Edite sua receita',
    'editRecipe.updating': 'Atualizando...',
    'editRecipe.updateButton': 'Atualizar Receita',
    'community.browseRecipes': 'Ver Receitas',
    'community.confirmDelete': 'Tem certeza que deseja deletar esta receita?',
    'community.deleteError': 'Erro ao deletar receita',
    edit: 'Editar',
    delete: 'Deletar',
    deleting: 'Deletando...',
    'aiRecipe.title': 'Gerar Receita com IA',
    'aiRecipe.subtitle': 'Informe os ingredientes que você tem e deixe a IA criar uma receita deliciosa para você!',
    'aiRecipe.description': 'Use inteligência artificial para criar receitas personalizadas com seus ingredientes favoritos',
    'aiRecipe.ingredientsField': 'Ingredientes',
    'aiRecipe.ingredientsPlaceholder': 'Ex: frango, tomate, cebola, alho (separados por vírgula)',
    'aiRecipe.ingredientsRequired': 'Por favor, informe pelo menos um ingrediente',
    'aiRecipe.cuisineField': 'Tipo de Culinária',
    'aiRecipe.cuisinePlaceholder': 'Ex: Italiana, Mexicana, Brasileira',
    'aiRecipe.mealTypeField': 'Tipo de Refeição',
    'aiRecipe.mealTypePlaceholder': 'Ex: Café da manhã, Almoço, Jantar',
    'aiRecipe.dietaryField': 'Restrições Alimentares',
    'aiRecipe.dietaryPlaceholder': 'Ex: Vegetariano, Sem glúten, Vegano',
    'aiRecipe.servingsField': 'Porções',
  ...
  es: {
    ...
    'community.noRecipes': 'Aún no hay recetas',
    'community.createFirst': 'Sé el primero en compartir una receta',
    ...
    'createRecipe.descriptionField': 'Descripción',
    'createRecipe.descriptionPlaceholder': 'Una breve descripción de la receta...',
    'createRecipe.prepTime': 'Tiempo de Preparación',
    'createRecipe.servingsField': 'Porciones',
    'createRecipe.category': 'Categoría',
    'createRecipe.categoryPlaceholder': 'Postre, Plato Principal, etc.',
    'createRecipe.cuisine': 'Cocina',
    'createRecipe.cuisinePlaceholder': 'Italiana, Brasileña, etc.',
    ...
    'createRecipe.onePerLine': 'uno por línea',
    ...
    'createRecipe.callToActionTitle': '👨‍🍳 ¡Comparte tus recetas!',
    'createRecipe.callToActionDesc': '¿Tienes una receta especial? ¡Compártela con la comunidad e inspira a otros cocineros!',
    'createRecipe.notAuthor': 'No tienes permiso para editar esta receta',
    'createRecipe.updateError': 'Error al actualizar receta',
    'editRecipe.title': 'Editar Receta',
    'editRecipe.subtitle': 'Actualiza la información de tu receta',
    'editRecipe.description': 'Edita tu receta',
    'editRecipe.updating': 'Actualizando...',
    'editRecipe.updateButton': 'Actualizar Receta',
    'community.browseRecipes': 'Ver Recetas',
    'community.confirmDelete': '¿Estás seguro de que quieres eliminar esta receta?',
    'community.deleteError': 'Error al eliminar receta',
    edit: 'Editar',
    delete: 'Eliminar',
    deleting: 'Eliminando...',
    ...
    'aiRecipe.cuisinePlaceholder': 'Ej: Italiana, Mexicana, Brasileña',
    'aiRecipe.mealTypeField': 'Tipo de Comida',
    'aiRecipe.mealTypePlaceholder': 'Ej: Desayuno, Almuerzo, Cena',
    'aiRecipe.dietaryField': 'Restricciones Dietéticas',
    ...
    'aiRecipe.error': 'Error al generar receta. Inténtalo de nuevo.',
    'aiRecipe.success': '¡Receta generada con éxito!',
