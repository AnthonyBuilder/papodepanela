...
const FeaturedSlider: React.FC<FeaturedSliderProps> = ({ recipes }) => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl md:rounded-2xl bg-gradient-to-br from-orange-50 to-amber-50 shadow-xl mb-6 md:mb-10">
      <div 
      ...
      >
        ...
        <button
          ...
          className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/30 hover:bg-white/90 rounded-full items-center justify-center shadow-lg transition-all backdrop-blur-sm"
          aria-label="Anterior"
        >
        ...
        <button
          onClick={goToNext}
          className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/30 hover:bg-white/90 rounded-full items-center justify-center shadow-lg transition-all backdrop-blur-sm"
          aria-label="Próximo"
        >
